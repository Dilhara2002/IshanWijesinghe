...
import { Award, Calendar, Download, ExternalLink, Sparkles, BadgeCheck } from "lucide-react";

const certificates = [
  {
    title: "Full Stack Web Development",
    issuer: "SLIIT Academy",
    date: "2024",
    description: "Comprehensive full-stack development certification covering modern web technologies including React, Node.js, MongoDB, and cloud deployment.",
    skills: ["React", "Node.js", "MongoDB", "Express", "REST APIs"],
    credentialId: "FSWD-2024-001",
    credentialUrl: "https://example.com/verify/FSWD-2024-001",
    badgeColor: "#6366f1",
  ...
  },
  {
    ...
    issuer: "Coursera",
    date: "2023",
    description: "Fundamental JavaScript programming concepts, ES6+ features, and practical web development skills.",
    skills: ["JavaScript", "ES6+", "DOM Manipulation", "Async Programming"],
    credentialId: "CJS-2023-045",
    credentialUrl: "https://coursera.org/verify/CJS-2023-045",
    badgeColor: "#a855f7",
  ...
  },
  {
    ...
    date: "2023",
    description: "User-centered design methodologies, prototyping, and usability testing techniques.",
    skills: ["Figma", "User Research", "Wireframing", "Prototyping"],
    credentialId: "GUX-2023-112",
    credentialUrl: "https://grow.google/ux-design/",
    badgeColor: "#10b981",
